//check fireEmployee(int id, int manageid)


import java.io.*;
public class Tester1_7 {
  public static void main(String[] args){
  
	try{
   	PrintStream o = new PrintStream(new File("Student_out1_7.txt"));
  ...
  //insert employees
    ...
    try
    {
    org.fireEmployee(10,1);
    System.out.println(org.toString(1));
    org.fireEmployee(532,1);
    org.fireEmployee(208,1);
    org.fireEmployee(1201,1);
    System.out.println(org.toString(25));
    System.out.println(org.toString(51));
    } 
    catch (IllegalIDException e)
    {
