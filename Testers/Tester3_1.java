...
import java.io.*;
public class Tester3_1 {
  public static void main(String[] args){
  
	try{
   	PrintStream o = new PrintStream(new File("Student_out3_1.txt"));
   ...
   //hireowner
    ...
    try
    {
    System.out.println(org.boss(300));
    System.out.println(org.toString(10));
    org.fireEmployee(300);
    System.out.println(org.toString(50));
    org.fireEmployee(50, 30);
    System.out.println(org.toString(10));
    org.hireEmployee(300, 15); 
    org.hireEmployee(50, 300);
    System.out.println(org.toString(15));
    System.out.println(org.toString(10));
    System.out.println(org.boss(50));
    }
    catch (IllegalIDException e)
    {
