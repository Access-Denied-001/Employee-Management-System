//check level
import java.io.*;
public class Tester1_8 {
  public static void main(String[] args){
  
	try{
   	PrintStream o = new PrintStream(new File("Student_out1_8.txt"));
...
//level
    try
    {
    System.out.println(org.level(25));
    System.out.println(org.level(532));
    System.out.println(org.level(92));
    System.out.println(org.level(1));
    System.out.println(org.level(99999));
    System.out.println(org.level(19));
    System.out.println(org.level(100000));
    System.out.println(org.level(1201));
    System.out.println(org.level(10));
    System.out.println(org.level(102));
