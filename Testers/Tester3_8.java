...
import java.io.*;
public class Tester3_8 {
  public static void main(String[] args){
  
	try{
   	PrintStream o = new PrintStream(new File("Student_out3_8.txt"));
   ...
   //hireowner
    ...
    System.out.println(org.toString(1));
    org.fireEmployee(7,6);
    System.out.println(org.toString(1));
     System.out.println(org.toString(5));
      System.out.println(org.toString(6));
    org.fireEmployee(5,6);
    System.out.println(org.toString(3));
    System.out.println(org.toString(1));
    }
    catch (IllegalIDException e)
    {
