...
import java.io.*;
public class Tester2_9 {
  public static void main(String[] args){
  
	try{
   	PrintStream o = new PrintStream(new File("Student_out2_9.txt"));
   ...
   //hireowner
    ...
    System.out.println(org.toString(300));
    
    System.out.println(org.toString(60));
    
    System.out.println(org.toString(30));
