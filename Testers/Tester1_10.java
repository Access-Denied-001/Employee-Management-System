...
import java.io.*;
public class Tester1_10 {
  public static void main(String[] args){
  
	try{
   	PrintStream o = new PrintStream(new File("Student_out1_10.txt"));
  ...
  //insert employees
    ...
    System.out.println(org.toString(666));
    System.out.println(org.toString(51));
    System.out.println(org.toString(208));
    }
    catch (IllegalIDException e)
    {
